...
const chuva2021 = <?= json_encode(array_column($tabela, "chuvaAcumuladaNoMes_2021")); ?>;
...
const mediaChuva2021SIM = calcularMedia(indicesReservatorios, chuva2021);
...
if (idxSIM >= 0) {
  ...
  chuva2021[idxSIM] = mediaChuva2021SIM;
}
...
new Chart(document.getElementById("grafChuva"), {
  ...
  options: {
    ...
    plugins: {
      legend: { position: "top" },
      title: { display: true, text: "Vazão e Chuva - Sistemas SABESP (<?php echo date('d/m/Y'); ?>)" },
    },
    scales: {
      y: {
        beginAtZero: true,
