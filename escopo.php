...
<head>
  ...
  <title>Sala de Situação de São Paulo - SSSP-SPAGUAS</title>
...
<body>
  ...
  <section class="hero section">
        ...
        <div class="col-lg-6">
          <h2 data-aos="fade-up" data-aos-delay="100" style="font-size:35px" class="p-4">SALA DE SITUAÇÃO <br/>DO ESTADO DE SÃO PAULO</h2>
            ...
            <div class="p-5 text-center">
                <a href="https://cth.daee.sp.gov.br/" target="_blank" class="btn btn-tranparent" data-aos="fade-up">Chuva Agora →</a>
            </div>
      </div>
    ...
    <section id="objetivo" class="objetivo p-5 ">
        <div class="container">
            <div class="row">
            <div class="col-lg-4 position-relative align-self-start order-lg-last order-last" data-aos="fade-up" data-aos-delay="200">
      ...
      <div class="row gy-4">
        <div class="col-lg-3" data-aos="fade-up" data-aos-delay="300">
          <div class="prod-item">
            ...
            <a href="boletins-diario.php" class="stretched-link">
        ...
        <div class="col-lg-3" data-aos="fade-up" data-aos-delay="200">
          <div class="prod-item">
            ...
            <a href="boletins-mensais.php" class="stretched-link">
              <h3>Boletins Mensais</h3>
            </a>
            <div>Boletins <strong>mensais</strong> pluviometria e estiagem</div>
          </div>
        </div>
  ...
  <section id="parceiros" class="parceiros">
    <div class="container" data-aos="fade-up">
      <div class="section-title">
        ...
        <div class="mb-4">Contamos com <strong>parcerias intitucionais</strong> que contribuem para o monitoramento hidrologico e climático. Juntos, ampliamos a capacidade de análise, previsão e resposta frente à variabilidade climática e à escassez hídrica no estado.</div>
      </div>
