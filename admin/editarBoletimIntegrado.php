...
$sql = "SELECT * FROM boletimIntegrado WHERE id = $id";
...
if (!empty($arquivo)) {
    ...
    // Atualiza no banco
    $sqlUpdate = "UPDATE boletimIntegrado SET data_upload='$data_upload', arquivo='$arquivo' WHERE id=$id";
} else {
    $sqlUpdate = "UPDATE boletimIntegrado SET data_upload='$data_upload' WHERE id=$id";
}

    if ($conn->query($sqlUpdate) === TRUE) {
        header("Location: listagemBoletimIintegrado.php"); // Voltar pra listagem
        exit();
    } else {
...
<section class="upload">
    <div class="container">
        <div class="col-lg-6 offset-lg-3">
            <h2><strong>Editar Boletim Integrado</strong></h2>
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <a href="listagemBoletimIntegrado.php" class="btn btn-secondary">Voltar</a>
                </form>
        </div>
    </div>
</section>
