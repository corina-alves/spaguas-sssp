  ...
  <header id="header" class="header  sticky-top">
    ...
    <section class="upload">
        <div class="container">
            ...
            <h2>Cadastrar <strong>Boletim Inegrado</strong></h2>
            <form method="post" enctype="multipart/form-data">
                <input class="form-control" type="text" name="nome" placeholder="Nome do boletim Integrado" required aria-label="Dar nome para o aquivo">
    ...
    if ($_POST) {
        $nome = $_POST['nome'];
        $arquivo = uniqid() . ".pdf";
        $caminho = "../upBoletimIntegrado/" . $arquivo;

        if (move_uploaded_file($_FILES['pdf']['tmp_name'], $caminho)) {
            $stmt = $conn->prepare("INSERT INTO boletimIntegrado2 (nome, arquivo) VALUES (?, ?)");
        ...
        echo "<script>setTimeout(() => { window.location.href = '../boletins-integrado.php'; });</script>";
        } else {
