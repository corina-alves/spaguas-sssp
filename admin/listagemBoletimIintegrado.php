...
<head>
  <meta charset="UTF-8">
  <title>Listagem de Boletins mensais SPI</title>
    ...
    <tbody>
        <?php if ($result->num_rows > 0): ?>
            ...
            <tr>
                ...
                <td>
                    <a href="editarBoletimIntegrado.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-warning"><i class="bi bi-pencil"></i> Editar</a>
                    <a href="excluirBoletimIntegrado.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Deseja excluir?');"><i class="bi bi-trash"></i> Excluir</a>
                </td>
            </tr>
            <?php endwhile; ?>
        <?php else: ?>
