...
<head>
    <meta charset="UTF-8">
    <title>Enviar boletins mensais SPI</title>
  ...
  <header id="header" class="header  sticky-top">
    ...
    <section class="upload">
        <div class="container">
            ...
            <h2>Cadastrar <strong>Boletim Hidrológico</strong></h2>
            <form method="post" enctype="multipart/form-data">
                <input class="form-control" type="text" name="nome" placeholder="Nome do boletim hidrológico" required aria-label="Dar nome para o aquivo">
    ...
    if ($_POST) {
        $nome = $_POST['nome'];
        $arquivo = uniqid() . ".pdf";
        $caminho = "../up_boletim_Hidro/" . $arquivo;

        if (move_uploaded_file($_FILES['pdf']['tmp_name'], $caminho)) {
            $stmt = $conn->prepare("INSERT INTO up_boletim_Hidro (nome, arquivo) VALUES (?, ?)");
        ...
        echo "<script>setTimeout(() => { window.location.href = '../boletins-hidrologico.php'; });</script>";
        } else {
